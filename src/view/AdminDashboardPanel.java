...
public class AdminDashboardPanel extends JPanel {
    ...
    private JPanel createSidebar() {
        ...
        sidebar.setBackground(UIConstants.primaryBgColor);
    ...
    private JButton createMenuButton(String text, String cardName) {
        ...
        button.setBackground(UIConstants.menuItemsBgColor);
    ...
    private JPanel gestionSuiviPage() {
        ...
        JLabel complete = new JLabel("Activités complètes : Musculation, Natation");
        JLabel active = new JLabel("Membres les plus actifs : Sami, Lina");

        complete.setFont(new Font("Arial", Font.PLAIN, 16));
        active.setFont(new Font("Arial", Font.PLAIN, 16));
